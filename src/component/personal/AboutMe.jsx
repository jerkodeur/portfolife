                ...
                <div className="row row--20">
                    ...
                    <div className="col-lg-7">
                        <div className="about-inner inner pt--100">
                            ...
                            <h2 className="title">À propos de <span onClick={toogleConnexion}> moi</span></h2>
