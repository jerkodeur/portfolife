                        ...
                        <div className="col-lg-8 order-2 order-lg-1">
                            <div className="section-title text-center mb--50 mt--60">
                                ...
                                <div className="contact-icons">
                                    <span onMouseOver={() => this.getTextIcon('Voir mon profil Linkedin')} onMouseOut={() => this.getTextIcon('')}>
                                        <a href="https://www.linkedin.com/in/j%C3%A9r%C3%B4me-poti%C3%A9/" target="_blank" rel="noopener noreferrer" >
                                            <FaLinkedin size="60" />
                                        </a>
                                    </span>
                                    <span onMouseOver={() => this.getTextIcon('Voir mon dépôt Github')} onMouseOut={() => this.getTextIcon('')}>
                                        <a href="https://github.com/jerkodeur" title="voir mon dépôt Github" target="_blank" rel="noopener noreferrer" >
                                            <FaGithub size="60" />
                                        </a>
                                    </span>
                                    <span onMouseOver={() => this.getTextIcon('Télécharger mon CV')} onMouseOut={() => this.getTextIcon('')}>
