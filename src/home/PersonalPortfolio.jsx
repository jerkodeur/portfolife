...
const SlideList = [
    {
        ...
        category: 'Développeur Web / Web Mobile',
        title: 'Salut, je m\'appelle <span>Jérôme</span> Bienvenue dans mon monde.',
        description: '',
        buttonText: '',
        buttonLink: ''
    }
...
class PersonalPortfolio extends Component{
    render(){
        ...
        description = "Attiré par le domaine de l'informatique depuis mon plus jeune âge, j'ai décidé de me donner aujourd'hui les moyens de réaliser mon rêve de gamin, à savoir devenir développeur !<br /><br />";
        return(
            <Fragment>
